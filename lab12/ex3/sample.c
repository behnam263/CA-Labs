...
extern int sequentialSearch (unsigned int *PriceListpt , unsigned int *ItemListpt);
extern int binarySearch (unsigned int *PriceListpt , unsigned int *ItemListpt);
...
{  
 ...
 // sequentialSearch(PriceList,ItemList);
 //	binarySearch(PriceList,ItemList);
