...
radical proc
		...
		mov radic,#1
loop1		
        udiv temp1, inouput,index
		mul temp2,temp1,index
		cmp temp2,inouput ; r0,r6
		addne index,#1	
		cmp temp2,inouput ; r0,r6
		beq areequal
		b notequal
areequal	
		mov inouput,temp1
		cmp previousindex,index
		beq notmjulti
		mulne radic,index
		movne previousindex,index
notmjulti
notequal	
